...
public class CourseInteractionController {
    ...
    public Result<CourseInteractionVO> interaction(@PathVariable Long courseId) {
    ...
    public Result<Void> favorite(@PathVariable Long courseId) {
    ...
    public Result<Void> unfavorite(@PathVariable Long courseId) {
    ...
    public Result<CourseReviewVO> review(@PathVariable Long courseId,
